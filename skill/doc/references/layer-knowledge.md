...
**与 requirements 层的边界**：需求文档（PRD、需求 txt、需求 issue）属于 **requirements 层**——它表达"需求方想要什么"。knowledge 层只收业务领域的**原始事实材料**——规章制度、业务规则、行业标准、流程规范，即"做这件事必须遵守/了解的客观知识"。判断标准：这份材料就算换一个项目做同样业务也仍然成立 → knowledge；它是针对本项目提出的诉求 → requirements。
