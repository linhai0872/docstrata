...
<h1 align="center">docstrata — layered context management for coding agents</h1>

<p align="center">Layered context that persists across sessions, so agents stop re-learning your project from scratch.</p>
...
I couldn't find a tool that handled structured, layered project context management well. Existing approaches were too lightweight — a single flat file can't capture the different *kinds* of knowledge a real project accumulates. So I built one.
